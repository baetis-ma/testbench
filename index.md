...
0xTPCC00NN   T=toggle no/yes, P=pol, CC=trigch
                           NN=numberchannels
0x09-0x0a
...
samplerate               0x0001 = 1usec/sample, etc 
0x0d-0x0e

triggeraddress         which sample is trigger time 
0x0f-0x1b
...
0x20-0x20+
  ...
  numberchannels
Data Payload
Data payload – see structure below

Structure of Payload Bytes  -  12 bits data + sync
MSB
0
ch(1)
ch(0)
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/baetis-ma/testbench/settings/pages). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
